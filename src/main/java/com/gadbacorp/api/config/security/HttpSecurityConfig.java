 ...
 */
package com.gadbacorp.api.config.security;
...
import com.gadbacorp.api.config.security.filter.JwtAuthenticationFilter;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers("/api/minimarket/detalles-compras/**").hasAuthority("ACCESS_COMPRAS")
                .requestMatchers("/api/minimarket/devoluciones-compra/**").hasAuthority("ACCESS_COMPRAS")
                .requestMatchers("/api/minimarket/proveedores/**").hasAuthority("ACCESS_COMPRAS")
                ...
                .requestMatchers("/api/minimarket/ajustes/**").hasAuthority("ACCESS_MANTENIMIENTO")
                ...
                .requestMatchers("/api/minimarket/inventarioproducto/**").hasAuthority("ACCESS_MANTENIMIENTO")

                .requestMatchers("/api/minimarket/delivery/**").hasAuthority("ACCESS_MANTENIMIENTO")
                .requestMatchers("/api/minimarket/estadomovimiento/**").hasAuthority("ACCESS_MANTENIMIENTO")
                .requestMatchers("/api/minimarket/vehiculo/**").hasAuthority("ACCESS_MANTENIMIENTO")
                ...
                .requestMatchers("/api/minimarket/unidad_medida/**").hasAuthority("ACCESS_MANTENIMIENTO")
                ...
                .requestMatchers("/api/minimarket/aperturas-cajas/**").hasAuthority("ACCESS_CAJAS")
                .requestMatchers("/api/minimarket/apertura-caja/**").hasAuthority("ACCESS_CAJAS")
                .requestMatchers("/api/minimarket/arqueos-cajas/**").hasAuthority("ACCESS_CAJAS")
                .requestMatchers("/api/minimarket/arqueo-caja/**").hasAuthority("ACCESS_CAJAS")
                .requestMatchers("/api/minimarket/cajas/**").hasAuthority("ACCESS_CAJAS")
                .requestMatchers("/api/minimarket/caja/**").hasAuthority("ACCESS_CAJAS")
                .requestMatchers("/api/minimarket/transacciones-cajas/**").hasAuthority("ACCESS_CAJAS")
                .requestMatchers("/api/minimarket/transaccion-caja/**").hasAuthority("ACCESS_CAJAS")
                .requestMatchers("/api/minimarket/transferencias-entre-cajas/**").hasAuthority("ACCESS_CAJAS")
                .requestMatchers("/api/minimarket/transferencia-entre-caja/**").hasAuthority("ACCESS_CAJAS")
