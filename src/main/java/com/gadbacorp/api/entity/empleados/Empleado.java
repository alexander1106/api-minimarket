...
public class Empleado {
    ...
    public Empleado(Integer idEmpleado, Sucursales sucursal, String nombre, String apellidos, String correoElectronico,
    ...
    public String toString() {
        return "empleado [idEmpleado=" + idEmpleado + ", sucursal=" + sucursal + ", nombre=" + nombre
